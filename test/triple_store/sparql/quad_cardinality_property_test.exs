defmodule TripleStore.SPARQL.QuadCardinalityPropertyTest do
  ...
  property "more specific patterns have lower or equal cardinality" do
    ...
    check all(
      ...
      all_vars_pat =
        {:quad, {:variable, "var1"}, {:variable, "var2"}, {:variable, "var3"},
         {:variable, "var4"}}

      one_bound_pat =
        {:quad, {:bound, s}, {:variable, "var"}, {:variable, "var"}, {:variable, "var"}}
  ...
  property "range selectivity is between 0 and 1" do
    check all(
            ...
            max_val <- StreamData.integer(0, 1000)
          ) do
