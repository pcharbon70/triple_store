...
| `AC-RT-07` | Every opened store carries one live coordinator used by public SPARQL updates; explicit external coordinators take precedence and remain caller-owned. | `test/triple_store/transaction_test.exs`, `test/triple_store/update_test.exs`, `test/triple_store/store_transaction_lifecycle_test.exs` |
